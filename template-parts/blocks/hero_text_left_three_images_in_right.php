 ...
 */
    ...
    $id = 'hero_text_left_3images_in_right-' . $block['id'];
    if( !empty($block['anchor']) ) {
        $id = $block['anchor'];
    }

    // Create class attribute allowing for custom "className" and "align" values.
    $className = 'hero_text_left_3images_in_right';
...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
    <div class="hero_text_left_3images__inner d-flex align-items-center" style="background-color: <?php echo $background_color; ?>; background-image: url('<?php echo $desktop_pattern_image; ?>')<?php if( $mobile_pattern_image ): ?>, url('<?php echo $mobile_pattern_image; ?>')<?php endif; ?>;">
        <div class="container">
            <div class="hero_text_left_3images_inner_section">
                <div class="hero_text_left_3images__container d-flex align-items-center" >
                    <div class="hero_text_left_3images__left">
                    ...
                    <div class="hero_text_left_3images__right">
                        <div class="hero_text_left_3images__images d-flex align-items-center">
