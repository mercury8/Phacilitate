<?php 
    $featured_post_id = get_query_var( 'postId' );
    $title = get_the_title( $featured_post_id );
    $link = get_the_permalink( $featured_post_id );
    $image = get_the_post_thumbnail_url( $featured_post_id, 'full' );
    $time = get_field('time', $featured_post_id);
    $location = get_field('location',$featured_post_id);
    $date = get_the_date( 'jS M Y',$featured_post_id );
    $short_description = get_field('short_description', $featured_post_id);
                            ?>
                            <div class="upcoming_event_webinars_list_item updated_upcoming">
                                <div class="upcoming_event_webinars_list_item_inner">
                                    <a class="upcoming_event_webinars_list_item_link" href="<?php echo $link; ?>"></a>
                                    <div class="upcoming_event_webinars_list_top">
                                    ...
                                    <div class="upcoming_event_webinars_list_Bottom">
